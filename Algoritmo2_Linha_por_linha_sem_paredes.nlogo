...
to go
  ask mowers [
    ;Inicialização (rodar para o sentido correto)
    if ticks = 0 [
      if [pxcor] of patch-here  > [pxcor]  of patch-ahead 1 [
        rt 180
      ]
      if [pycor] of patch-here < [pycor] of patch-ahead 1 [
        rt 90
      ]
      if [pycor] of patch-here > [pycor] of patch-ahead 1 [
        rt -90
    ...
    if moveok = 0 and [pcolor] of patch-ahead 1 = green [
